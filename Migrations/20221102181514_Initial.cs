...
namespace _2nd_Team_Week_MVC.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoreReq = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCard_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                table: "Card",
                columns: new[] { "CardId", "Difficulty", "ImageUrl", "ScoreReq", "Title", "Type" },
                values: new object[] { 1, "beginner", "css/assets/img/card1.webp", 15, "Amateur Botanist", "Score" });
